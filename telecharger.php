                    ...
                    <div class="row">
                        ...
                        echo'<div class="border-3 ">';
                          ...
                          <div class=" row card-body  ">
                                <div class="col-lg-10 " style="color: green; font-size:30px;">
                                    <h5 class="card-title text-success">'.$ligne['type'].'</h5>
                                    <p class="card-text text-success">'.$ligne['libcrs'].':'.$ligne['libres'].'</p>
                                </div>
                                <div class="col-lg-2">
                                    <a id="ah" href="telecharger.php?urll='.$ligne['fichier'].'" class="btn btn-success  pl-0">Telecharger</a>
                                </div>
                          </div>
                      </div>';
                      }
